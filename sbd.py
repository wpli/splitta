...
## globals
SVM_LEARN = '/afs/csail.mit.edu/proj/lfe-language/legalcode/states/code/svm_light/svm_learn'
SVM_CLASSIFY = '/afs/csail.mit.edu/proj/lfe-language/legalcode/states/code/svm_light/svm_classify'
